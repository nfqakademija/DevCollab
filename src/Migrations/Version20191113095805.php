 ...
 */
final class Version20191113095805 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE team_tasks (id INT AUTO_INCREMENT NOT NULL, teamfk INT NOT NULL, task VARCHAR(255) NOT NULL, create_by INT DEFAULT NULL, status TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
