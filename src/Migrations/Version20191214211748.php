 ...
 */
final class Version20191214211748 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE team_points CHANGE team_id team_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE team_id team_id INT DEFAULT NULL, CHANGE name name VARCHAR(255) DEFAULT NULL, CHANGE lastname lastname VARCHAR(255) DEFAULT NULL, CHANGE username username VARCHAR(255) DEFAULT NULL, CHANGE location location VARCHAR(255) DEFAULT NULL, CHANGE github_username github_username VARCHAR(255) DEFAULT NULL, CHANGE roles roles VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE projects DROP INDEX IDX_5C93B3A4296CD8AE, ADD UNIQUE INDEX UNIQ_5C93B3A4296CD8AE (team_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE projects DROP INDEX UNIQ_5C93B3A4296CD8AE, ADD INDEX IDX_5C93B3A4296CD8AE (team_id)');
