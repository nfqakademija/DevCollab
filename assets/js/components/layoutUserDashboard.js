...
const CLASSES = {
    container: "min-h-screen w-full poppins bg-gray-100 flex flex-col justify-between relative",
    header: {
        container: "w-full h-16 bg-white flex justify-between items-center px-2 border-b border-gray-400 fixed top-0 z-20",
        logo: "text-2xl font-bold",
        logoutBtn: "text-md lg:text-lg text-center font-semibold text-black border-2 border-gray-800 rounded px-2 lg:px-4 py-1 mr-1 cursor-pointer hover:text-gray-100 hover:bg-gray-800 "
    },
    ...
    navigation: {
        ...
        links: " xl:hover:shadow-lg xl:hover:text-black xl:hover:pointer-cursor xl:hover:border xl:hover:border-gray-200 xl:hover:rounded-lg p-2 xl:flex xl:flex-row xl:items-center xl:justify-start xl:text-lg xl:my-3 xl:w-full xl:mx-auto xl:px-4 ",
...
const LayoutUserDashboard = ({ handleLogout, location, children }) => (
    <div className={container}>
        <div className={header.container}>
            <Link to="/" className={header.logo}>DevCollab</Link>
            <Link to="/" onClick={handleLogout} className={header.logoutBtn}>Logout</Link>
        </div> 
        ...
        <div className={navigation.container}>
            <NavLink 
                ...
                >
                {location.pathname === "/" ? <span className={navigation.greenDot}></span> : null}
            ...
            <NavLink 
                ...
                activeClassName={`${navigation.linksActive}`}
            >
                {location.pathname === "/profile" ? <span className={navigation.greenDot}></span> : null}
            ...
            <NavLink
                ...
                activeClassName={`${navigation.linksActive}`}
            >
                {location.pathname === "/scoreboard" ? <span className={navigation.greenDot}></span> : null}
