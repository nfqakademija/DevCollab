 ...
 */
final class Version20191213212710 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, team_id INT DEFAULT NULL, skills_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, location VARCHAR(255) DEFAULT NULL, github_username VARCHAR(255) DEFAULT NULL, short_description LONGTEXT DEFAULT NULL, roles LONGTEXT DEFAULT NULL, INDEX IDX_1483A5E9296CD8AE (team_id), INDEX IDX_1483A5E97FF61858 (skills_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
