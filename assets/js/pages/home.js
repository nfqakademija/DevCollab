...
const CLASSES = {
    ...
    hiw: {
        ...
        imageRight: "px-2 lg:px-0 hiw-image-bg hiw-rounded-l -ml-2 lg:ml-0 flex justify-center lg:justify-start items-center",
        content: "w-full mx-auto",
        contentRight: "order-1 lg:order-2 w-full flex flex-col justify-center mb-8 px-2 lg:px-8 xl:px-64 sm:mb-12",
        contentLeft: "w-full flex flex-col justify-center mb-8 px-2 lg:px-8 xl:px-64 sm:mb-12",
        contentTitle: "text-3xl font-semibold text-center lg:text-left text-gray-900",
